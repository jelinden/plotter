  ...
  function f(n) {
    ...
    function Z(n, t, e) {
      ...
      var o = "__on" + n,
        a = n.indexOf("."),
        c = V;
      a > 0 && (n = n.slice(0, a));var l = Ca.get(n);
      return l && (n = l, c = X), a ? t ? u : r : t ? y : i
    }
    function V(n, t) {
      return function(e) {
        var r = ta.event;
        ta.event = e, t[0] = this.__data__;try {
          n.apply(this, t)
        } finally {
          ta.event = r
        }
    ...
    function B(n, t) {
      t.changedTouches && (t = t.changedTouches[0]);var e = n.ownerSVGElement || n;
      if (e.createSVGPoint) {
    ...
    function bt(n, t, e) {
      ...
      if (r = /([a-z]+)\((.*)\)/i.exec(n)) switch (u = r[2].split(","), r[1]) {
          case "hsl":return e(parseFloat(u[0]), parseFloat(u[1]) / 100, parseFloat(u[2]) / 100);case "rgb":return t(kt(u[0]), kt(u[1]), kt(u[2]))
      }
    ...
    function wt(n, t, e) {
      n = St(n), t = St(t), e = St(e);var r = vt((.4124564 * n + .3575761 * t + .1804375 * e) / Ja),
    ...
    function Ut(n) {
      ...
      return function(n) {
        ...
        switch (h && (h = +h.substring(1)), (l || "0" === r && "=" === o) && (l = r = "0", o = "="), g) {
          case "n":f = !0, g = "g";
            break;case "%":p = 100, d = "%", g = "f";
            break;case "p":p = 100, d = "%", g = "r";
            break;case "b":
          case "o":
          case "x":
          case "X":"#" === c && (v = "0" + g.toLowerCase());case "c":y = !1;case "d":m = !0, h = 0;
            break;case "s":p = -1, g = "r"
        }
    ...
    function Ht(n, t, e) {
      ...
      n.floor = n, n.round = r, n.ceil = u, n.offset = i, n.range = o;var c = n.utc = Ot(n);
    ...
    function Yt(n) {
      ...
      function e(n, t, e, r) {
        for (var u, i, o, a = 0, c = t.length, l = e.length; c > a;) {
          ...
          function i(n, t, e) {
            E.lastIndex = 0;var r = E.exec(t.slice(e));
          ...
          t.utc = function(n) {
            ...
            return e.parse = function(n) {
                try {
                  hc = Ft;var t = r.parse(n);
                  return t && t._
                } finally {
                  hc = Date
                }
              }, e.toString = r.toString, e
          }, t.multi = t.utc.multi = ce;var M = ta.map(),
            x = Zt(v),
            b = Vt(v),
            _ = Zt(d),
            w = Vt(d),
        ...
        function Xt(n, t, e) {
          vc.lastIndex = 0;var r = vc.exec(t.slice(e, e + 1));
          return r ? (n.w = +r[0], e + r[0].length) : -1
        }
        function $t(n, t, e) {
          vc.lastIndex = 0;var r = vc.exec(t.slice(e));
        ...
        function Wt(n, t, e) {
          vc.lastIndex = 0;var r = vc.exec(t.slice(e, e + 4));
          return r ? (n.y = +r[0], e + r[0].length) : -1
        }
        function Jt(n, t, e) {
          vc.lastIndex = 0;var r = vc.exec(t.slice(e, e + 2));
        ...
        function te(n, t, e) {
          vc.lastIndex = 0;var r = vc.exec(t.slice(e, e + 3));
        ...
        function ae(n, t, e) {
          dc.lastIndex = 0;var r = dc.exec(t.slice(e, e + 1));
        ...
        function de(n, t) {
          ...
          function Ie(n, t, e, r) {
            ...
            return function(a) {
              ...
              function p(n, t) {
                n = Math.max(-Uc, Math.min(Uc, n)), t = Math.max(-Uc, Math.min(Uc, t));var e = s(n, t);
          ...
          function wr(n, t) {
            function e(n, t) {
              o > 0 ? -ja + Ta > t && (t = -ja + Ta) : t > ja - Ta && (t = ja - Ta);var e = o / Math.pow(u(t), i);
          ...
          function qr(n, t) {
            ...
            function Fr(n) {
              for (var t, e, r, u, i = n.x, o = n.y, a = rl._; a;)
                if (r = Hr(a, o) - i, r > Ta)
                  a = a.L; else {
                  if (u = i - Or(a, o), !(u > Ta)) {
                    r > -Ta ? (t = a.P, e = a) : u > -Ta ? (t = a, e = a.N) : t = e = a;break
                  }
                  if (!a.R) {
                    t = a;break
                  }
            ...
            function ou(n, t) {
              ...
              for (tl = [], el = new Array(n.length), rl = new tu, il = new tu;;)
                if (u = ul, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== e || i.y !== r) && (el[i.i] = new Yr(i), Fr(i), e = i.x, r = i.y), i = n.pop(); else {
                  if (!u) break;
                  jr(u.arc)
              }
              t && (Br(t), Ir(t));var o = {
                  ...
                  if (!(s > i || f > o || r > h || u > g)) {
                    ...
                    for (var M = n.nodes, x = .5 * (s + h), b = .5 * (f + g), _ = t >= x, w = e >= b, S = w << 1 | _, k = S + 4; k > S; ++S)
                      if (n = M[3 & S]) switch (3 & S) {
                          case 0:l(n, s, f, x, b);
                            break;case 1:l(n, x, f, h, b);
                            break;case 2:l(n, s, b, x, g);
                            break;case 3:l(n, x, b, h, g)
                    }
                  }
                }(n, r, u, i, o), a
            }
            function pu(n, t) {
              n = ta.rgb(n), t = ta.rgb(t);var e = n.r,
                r = n.g,
                u = n.b,
                i = t.r - e,
                o = t.g - r,
            ...
            function Tu(n, t) {
              n = ta.hcl(n), t = ta.hcl(t);var e = n.h,
                r = n.c,
                u = n.l,
                i = t.h - e,
                o = t.c - r,
            ...
            function Ru(n, t) {
              n = ta.hsl(n), t = ta.hsl(t);var e = n.h,
                r = n.s,
                u = n.l,
                i = t.h - e,
                o = t.s - r,
            ...
            function Du(n, t) {
              n = ta.lab(n), t = ta.lab(t);var e = n.l,
                r = n.a,
                u = n.b,
                i = t.l - e,
                o = t.a - r,
                    ...
                    function $o(n, t, e, r, u) {
                      ...
                      if (!o) {
                        ...
                        o = i[r] = {
                          ...
                          function s(u) {
                            return o.event && o.event[u ? "end" : "interrupt"].call(n, g, t), --i.count ?
                                delete i[r]
                                :
                                delete n[e]
                              , 1
                    ...
                    var Ma = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
                      ...
                      ta.ns = {
                        ...
                        tc.forEach(function(n, t) {
                          ...
                          function e(n, e, i) {
                            arguments.length < 3 && (i = e, e = null);var o = Ct(n, t, null == e ? r : u(e), i);
                              ...
                              function e() {
                                ...
                                for (; l > s;) {
                                  var r = n.charCodeAt(s++),
                                    a = 1;
                                  if (10 === r)
                                    u = !0;else if (13 === r) u = !0, 10 === n.charCodeAt(s) && (++s, ++a);else if (r !== c) continue;
                        ...
                        ta.formatPrefix = function(n, t) {
                          ...
                          ta.geo.bounds = function() {
                            ...
                            var Sc, kc, Ec, Ac, Nc, Cc, zc, qc, Lc, Tc, Rc,
                              Dc = {
                                sphere: y,
                                point: we,
                                lineStart: ke,
                            ...
                            Yr.prototype.prepare = function() {
                              ...
                              insert: function(n, t) {
                                ...
                                if (n) {
                                  ...
                                  this._ ? (n = iu(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, this._ = t, e = null);
                                  ...
                                  do {
                                    ...
                                    if (n === u.L) {
                                      if (t = u.R, t.C && (t.C = !1, u.C = !0, ru(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
                                        t.R && t.R.C || (t.L.C = !1, t.C = !0, uu(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, ru(this, u), n = this._;break
                                      }
                                    } else if (t = u.L, t.C && (t.C = !1, u.C = !0, uu(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
                                      t.L && t.L.C || (t.R.C = !1, t.C = !0, ru(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, uu(this, u), n = this._;break
                                    }
                                    t.C = !0, n = u, u = u.U
                                  } while (!n.C);
                                  n && (n.C = !1)
                            ...
                            ta.geom.delaunay = function(n) {
                              ...
                              function i(n) {
                                  ...
                                  if (!isNaN(e) && !isNaN(r))
                                    if (n.leaf) {
                                      var c = n.x,
                                        s = n.y;
                                      if (null != c)
                                        if (va(c - e) + va(s - r) < .01) l(n, t, e, r, u, i, o, a); else {
                                          var f = n.point;
                                ...
                                var s, f, h, g, p, v, d, m, y,
                                  M = Et(a),
                                  x = Et(c);
                                if (null != t) v = t, d = e, m = r, y = u;else if (m = y = -(v = d = 1 / 0), f = [], h = [], p = n.length, o)
                              ...
                              ta.layout.stack = function() {
                                function n(a, c) {
                                  ...
                                  var l = a.map(function(e, r) {
                                    ...
                                    f = e.call(n, s, c);
                                  l = ta.permute(l, f), s = ta.permute(s, f);var h, g, p, v,
                                    d = r.call(n, s, c),
                                    m = l[0].length;
                                  for (p = 0; m > p; ++p)
                                ...
                                ta.svg.line.radial = function() {
                                  ...
                                  ta.svg.brush = function() {
                                    ...
                                    var Bl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
                                      Wl = [[fc.second, 1], [fc.second, 5], [fc.second, 15], [fc.second, 30], [fc.minute, 1], [fc.minute, 5], [fc.minute, 15], [fc.minute, 30], [fc.hour, 1], [fc.hour, 3], [fc.hour, 6], [fc.hour, 12], [fc.day, 1], [fc.day, 2], [fc.week, 1], [fc.month, 1], [fc.month, 3], [fc.year, 1]],
                                      Jl = Vl.multi([[".%L", function(n) {
